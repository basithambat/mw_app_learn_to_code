...
class _AddChildScreenState extends State<AddChildScreen> {
  ...
  void initState() {
    ...
    if (widget.existingChild != null) {
      _nameController.text = widget.existingChild!['fullName'] ?? '';
      _relationship = widget.existingChild!['relationship'];
      _photoUrl = widget.existingChild!['photoUrl'];
      if (widget.existingChild!['dateOfBirth'] != null) {
        _dateOfBirth = DateTime.parse(widget.existingChild!['dateOfBirth']);
      }
    }
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (widget.existingChild != null && widget.willId != null) {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Blood-one, stepchildrens or adopted',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: _buildRelationshipOption('SON', 'Son'),
                          ),
                          const SizedBox(width: 12),
                          Expanded(
                            child: _buildRelationshipOption('DAUGHTER', 'Daughter'),
                          ),
                        ],
                      ),
