...
class OnboardingChildrenScreen extends StatefulWidget {
  final String userName;
  final Function(bool hasChildren)? onContinue;
  final VoidCallback? onBack;

  const OnboardingChildrenScreen({
    Key? key,
  ...
  @override
  State<OnboardingChildrenScreen> createState() => _OnboardingChildrenScreenState();
}

class _OnboardingChildrenScreenState extends State<OnboardingChildrenScreen> {
  bool? _hasChildren;

  void _handleContinue() {
    if (_hasChildren != null) {
      widget.onContinue?.call(_hasChildren!);
    }
  }
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: PrimaryButton(
                      text: 'Continue',
                      onPressed: _hasChildren != null ? _handleContinue : null,
                      backgroundColor: _hasChildren != null
